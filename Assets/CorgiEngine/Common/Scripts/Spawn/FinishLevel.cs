...
{    
    ...
    public class FinishLevel : ButtonActivated 
    {
        ...
        [MMInspectorGroup("Coin Collection", true, 30)]
        
        /// the number of coins needed to finish the level
        [Tooltip("the number of coins needed to finish the level")]
        ...
        public override void TriggerButtonAction(GameObject instigator)
        {
            ...
            {
                // If not all coins are collected, display a message and return
                Debug.Log("You need to collect all the coins to finish the level!");
                return;
            }
